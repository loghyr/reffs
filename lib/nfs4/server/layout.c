...
_Static_assert((int)REFFS_ENCODING_REPLICATED == (int)FFV2_ENCODING_REPLICATED,
	       "REFFS_ENCODING_REPLICATED must match FFV2_ENCODING_REPLICATED");
...
_Static_assert(
	(int)REFFS_ENCODING_HAMMERSPACE_SNAPRAID_CAUCHY ==
		(int)FFV2_ENCODING_HAMMERSPACE_SNAPRAID_CAUCHY,
	"REFFS_ENCODING_HAMMERSPACE_SNAPRAID_CAUCHY must match FFV2_ENCODING_HAMMERSPACE_SNAPRAID_CAUCHY");
_Static_assert(
	(int)REFFS_ENCODING_HAMMERSPACE_ISA_L_RS ==
		(int)FFV2_ENCODING_HAMMERSPACE_ISA_L_RS,
	"REFFS_ENCODING_HAMMERSPACE_ISA_L_RS must match FFV2_ENCODING_HAMMERSPACE_ISA_L_RS");
#endif
