...
nfs4_op_cb op_table[OP_MAX] = {
	...
	[OP_CHUNK_ESCROW_INSTALL] = nfs4_op_chunk_escrow_install,
	[OP_CHUNK_ESCROW_RELEASE] = nfs4_op_chunk_escrow_release,
	[OP_CHUNK_ESCROW_ENUMERATE] = nfs4_op_chunk_escrow_enumerate,
	[OP_CHUNK_ESCROW_TAKEOVER] = nfs4_op_chunk_escrow_takeover,
	[OP_PROXY_REGISTRATION] = nfs4_op_proxy_registration,
	[OP_PROXY_PROGRESS] = nfs4_op_proxy_progress,
	[OP_PROXY_DONE] = nfs4_op_proxy_done,
