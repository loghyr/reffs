...
void d2_store_fail_next_wal_write(struct d2_store *store);
...
uint64_t d2_store_wal_promised(struct d2_store *store);
uint64_t d2_store_recovery_allowance(struct d2_store *store);
