...
int reffs_fuse_fallocate(const char *path, int mode, off_t offset, off_t len,
			 struct fuse_file_info *info);
int reffs_fuse_flush(const char *path, struct fuse_file_info *info);
...
int reffs_fuse_open(const char *path, struct fuse_file_info *info);
...
int reffs_fuse_release(const char *path, struct fuse_file_info *info);
